...
NOTE: we asked the authors for assistance and they sent us more details. They send they used the following function to calculate within-subject standard errors:
...
NOTE - the authors clarified that they did use a Greenhouse-Geisser correction and said they used the aov_ez function from the afex package.
...
Initially, we did not attempt the ANOVA as it appeared that a correction has been applied and the correction was not identified. The authors told us that this was a Greenhouse-Geisser correction, and told us which R function they used... tbc
