...
This was our first attempt to run a 2x3 within-subjects ANOVA:
...
We encountered a number of errors (2 major) when we first ran this. The authors informed us that some of the data was actually excluded and this was not reported in the paper. They also provided some code to implement the exclusion and run the ANOVA (note we had to make some minor edits to get it to work):
...
Everything matches now (apart from one minor numerical).
